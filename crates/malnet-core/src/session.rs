...
impl Session {
    ...
    pub fn derive_master_key(&mut self, shared_secret: &[u8; 32]) -> [u8; 32] {
    ...
    pub fn encrypt_packet(&mut self, key: &[u8; 32], plaintext: &[u8]) -> Vec<u8> {
    ...
    pub fn decrypt_packet(&mut self, key: &[u8; 32], packet: &[u8]) -> Option<Vec<u8>> {
