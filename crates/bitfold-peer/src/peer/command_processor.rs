            ...
            ProtocolCommand::Connect {
                ...
                if self.state == PeerState::Idle {
                    ...
                    let verify_command = ProtocolCommand::VerifyConnect {
                        ...
                        incoming_session_id: self.outgoing_session_id, // Server's outgoing (from client's perspective = incoming)
                        outgoing_session_id: self.incoming_session_id, // Client's outgoing (echo it back for verification)
